...
def Introduction_to_simulation():
    ...
    print("The removed are all the individuals who cannot be affected due to immunity developed during the infection, immune due to vaccination or have died due to disease.")
